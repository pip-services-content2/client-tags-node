...
import { TagsLambdaClientV1 } from '../version1';
...
export class TagsClientFactory extends Factory {
	...
	public static LambdaClientV1Descriptor = new Descriptor('service-tags', 'client', 'lambda', 'default', '1.0');
	...
	constructor() {
		...
		this.registerAsType(TagsClientFactory.LambdaClientV1Descriptor, TagsLambdaClientV1);
	}
